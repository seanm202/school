  ...
  <x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
          <button class="btn btn-primary" id="menu-toggle" style="position:fixed;">Toggle Menu</button>     {{ __('Teacher') }}   @if(Session::has('success'))
    ...
    <div class="bg-light border-right" id="sidebar-wrapper" style="position: fixed;background-color:red;">
      ...
      <div class="list-group list-group-flush" style="max-height: 330px;overflow-y:scroll;">
        <ul>
          <li>
          <a href="#addTeacherAdmin" class="list-group-item list-group-item-action bg-light">Add a teacher</a>
        </li>
          </ul>
      </div>
    </div>
