    ...
    <div class="modal" id="add-project-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form data-action="{{ route('attendence.markTodaysAttendance') }}" method="POST" enctype="multipart/form-data" id="add-project-form">
                    <!-- Modal body -->
                                            @csrf
                    <div class="modal-body">
                      ...
                      {{Form::hidden('userRole',3,array('id'=>'userRole'))}}{{Form::hidden('userId',5,array('id'=>'userId'))}}
